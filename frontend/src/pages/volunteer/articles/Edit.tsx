...
export default function ArticleEdit() {
  ...
  const { data: article, isLoading, isError } = useQuery({
    ...
    queryFn: () => articlesApi.myArticle(articleId),
    retry: false,
  });
  ...
  const save = useMutation({
    ...
    onSuccess: () => qc.invalidateQueries({ queryKey: ["my-article", articleId] }),
  });
  ...
  if (isError || !article) return <p className="text-sm text-rust-600">আর্টিকেল লোড করা যায়নি — লিস্টে ফিরে যাও এবং আবার চেষ্টা করো।</p>;
  ...
  return (
    <div className="max-w-2xl space-y-4">
      ...
      <Card className="space-y-3">
        ...
        {/* Album/Cover manager এখন editor-এর নিজের toolbar-এর ভেতরে ("📷 ছবি ও কভার" বাটন) */}
        <RichTextEditor content={body} onChange={setBody} articleId={articleId} />
